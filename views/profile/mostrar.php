...
<li class="dropdown">
          ...
          <img src="<?php echo ucfirst($_SESSION['foto']); ?> " style="width:40px; height:40px; border-radius:50%;"/>
      ...
      <form action="" enctype="multipart/form-data" method="POST" autocomplete="off">
        <div class="card-body">
          <div class="d-flex flex-column align-items-center text-center">
            <img id="profileImage" src="<?php echo ucfirst($_SESSION['foto']); ?>  " width="150">
            <div class="mt-3">        
              <h4><?php echo ucfirst($_SESSION['nombre_usuario']); ?></h4>
              
              <p class="text-secondary mb-1"><?php echo ucfirst($_SESSION['nombre_completo']); ?></p>
              <input type="file" id="imagen" name="foto" class="btn btn-outline-primary" onchange="previewImage(event);" data-toggle="tooltip">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo ucfirst($_SESSION['nombre_usuario']); ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo ucfirst($_SESSION['nombre_completo']); ?>
                    </div>
                  </div>
