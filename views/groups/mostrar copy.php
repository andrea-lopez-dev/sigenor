...
?>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="entrar?id=<?php echo htmlspecialchars($producto['id_seccion']); ?>" 
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <select required id="seccion" name="seccion" class="form-control">
...
if (isset($_POST['agregar'])) {
    try {
        ...
        $sql->bindParam(':nombre_seccion', $seccion, PDO::PARAM_INT);
