...
<tr>
  ...
  <tr>
    <td style="text-align: left;  font-size: 7px; border: 1px solid black; vertical-align: middle; padding: 5px;" rowspan="2">'.$periodo1[4]['nombre_curso'].'</td>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$nombre_curso[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo1[4]['te'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo1[4]['mes'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo1[4]['anio'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo1[4]['numero_plantel'].'</td>
  </tr>
  <tr>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$nombre_curso[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo1[4]['te'].'</td>
...
<tr>
  ...
  <!-- Aprobado / No Aprobado -->
  <tr>
    <td style="text-align: left;  font-size: 7px; border: 1px solid black; vertical-align: middle; padding: 5px;" rowspan="2">'.$periodo2[4]['nombre_curso'].'</td>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo2[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo2[4]['te'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo2[4]['mes'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo2[4]['anio'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo2[4]['numero_plantel'].'</td>
  </tr>
  <tr>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo2[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo2[4]['te'].'</td>
...
<tr>
  ...
  <!-- Aprobado / No Aprobado -->
  <tr>
    <td style="text-align: left;  font-size: 7px; border: 1px solid black; vertical-align: middle; padding: 5px;" rowspan="2">'.$periodo3[4]['nombre_curso'].'</td>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo3[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo3[4]['te'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo3[4]['mes'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo3[4]['anio'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo3[4]['numero_plantel'].'</td>
  </tr>
  <tr>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo3[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo3[4]['te'].'</td>
...
<tr>
  ...
  <!-- Aprobado / No Aprobado -->
  <tr>
    <td style="text-align: left;  font-size: 7px; border: 1px solid black; vertical-align: middle; padding: 5px;" rowspan="2">'.$periodo4[4]['nombre_curso'].'</td>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo4[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo4[4]['te'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo4[4]['mes'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo4[4]['anio'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo4[4]['numero_plantel'].'</td>
  </tr>
  <tr>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo4[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo4[4]['te'].'</td>
...
<tr>
  ...
  <!-- Aprobado / No Aprobado -->
  <tr>
    <td style="text-align: left;  font-size: 7px; border: 1px solid black; vertical-align: middle; padding: 5px;" rowspan="2">'.$periodo5[4]['nombre_curso'].'</td>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo5[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo5[4]['te'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo5[4]['mes'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo5[4]['anio'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo5[4]['numero_plantel'].'</td>
  </tr>
  <tr>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo5[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo5[4]['te'].'</td>
...
<tr>
  ...
  <!-- Aprobado / No Aprobado -->
  <tr>
    <td style="text-align: left;  font-size: 7px; border: 1px solid black; vertical-align: middle; padding: 5px;" rowspan="2">'.$periodo6[4]['nombre_curso'].'</td>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo6[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo6[4]['te'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo6[4]['mes'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo6[4]['anio'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo6[4]['numero_plantel'].'</td>
  </tr>
  <tr>
    <td colspan="2" style="width: 65px; height: 5px; font-size: 7px; border: 1px solid black; text-align: left; vertical-align: middle; padding: 5px;">'.$periodo6[4]['calificacion_letras'].'</td>
    <td style="border: 1px solid black; text-align: center; padding: 5px;">'.$periodo6[4]['te'].'</td>
